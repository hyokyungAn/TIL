...
<img width="779" alt="스크린샷 2023-05-01 오후 10 42 59" src="https://user-images.githubusercontent.com/104885245/235461226-3a261233-1c91-4dbd-9f67-8bfd732d2014.png">

> `git branch -r`: 브랜치 목록 - origin/HEAD : 원격 저장소의 현재 브랜치(원격 저장소는 master가 기본 브랜치)
...
* 현재 브랜치에서 현재 브랜치를 지울 수 없기 때문에 

> `git checkout master`로 이동

> `git branch -d 삭제할 브랜치 이름: 삭제
